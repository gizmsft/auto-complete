function AjaxCallSynchronizer(e){"use strict";this.execute=function(){var e;t.timer&&clearTimeout(t.timer),e=Array.prototype.slice.call(arguments),t.timer=setTimeout(function(){t.timer=void 0,t.settings.apiRequest.apply(this,e)},t.settings.apiRequestDelay)};var t={settings:{},timer:void 0};t.settings=$.extend(!0,{},{apiRequestDelay:0,apiRequest:void 0},e)}
